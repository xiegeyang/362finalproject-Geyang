...
if (!isset($_SESSION["cart_array"]) || count($_SESSION["cart_array"]) < 1) {
    ...
    <input type="hidden" name="business" value="DJ@djbookStore.com">';
    ...
    foreach ($_SESSION["cart_array"] as $each_item) { 
		...
		*/
		$x= $i+1;
		$pp_checkout_btn .= '<input type="hidden" name="pricetotal" value="' . $cartTotal . '">
...
*/	$pp_checkout_btn .= '<input type="hidden" name="custom" value="' . $product_id_array . '">
	<?php ?><input type="hidden" name="notify_url" value="https://www.yoursite.com/storescripts/my_ipn.php">
	<button style="margin-top:5px;" type="submit" value="submit" name="submit">Proceed to checkout</button>
<?php ?>	</form>';
}
?>
...
<div align="center" id="mainWrapper">
  ...
  <div id="pageContent">
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="6">
      <tr>
        <td width="18%" bgcolor="#C5DFFA"><strong>Book </strong></td>
        <td width="45%" bgcolor="#C5DFFA"><strong>Author</strong></td>
